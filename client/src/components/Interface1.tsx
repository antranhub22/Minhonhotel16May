...
const Interface1: React.FC<Interface1Props> = ({ isActive }) => {
  ...
  const TabBar = () => (
    ...
    >
      <button onClick={() => setActiveMenu('tours')} className={`flex-shrink-0 min-w-[160px] sm:min-w-[120px] px-4 py-2 rounded-full font-bold text-base sm:text-sm scroll-snap-align-start ${activeMenu==='tours' ? 'bg-amber-400 text-pink-900 shadow' : 'bg-transparent text-amber-300'}`}>{t('tourism_tour', lang)}</button>
      <button onClick={() => setActiveMenu('bus')} className={`flex-shrink-0 min-w-[160px] sm:min-w-[120px] px-4 py-2 rounded-full font-bold text-base sm:text-sm scroll-snap-align-start ${activeMenu==='bus' ? 'bg-amber-400 text-pink-900 shadow' : 'bg-transparent text-amber-300'}`}>{t('ticket_bus', lang)}</button>
      <button onClick={() => setActiveMenu('vehicle')} className={`flex-shrink-0 min-w-[160px] sm:min-w-[120px] px-4 py-2 rounded-full font-bold text-base sm:text-sm scroll-snap-align-start ${activeMenu==='vehicle' ? 'bg-amber-400 text-pink-900 shadow' : 'bg-transparent text-amber-300'}`}>{t('rental_service', lang)}</button>
      <button onClick={() => setActiveMenu('currency')} className={`flex-shrink-0 min-w-[160px] sm:min-w-[120px] px-4 py-2 rounded-full font-bold text-base sm:text-sm scroll-snap-align-start ${activeMenu==='currency' ? 'bg-amber-400 text-pink-900 shadow' : 'bg-transparent text-amber-300'}`}>{t('currency_exchange', lang)}</button>
      <button onClick={() => setActiveMenu('laundry')} className={`flex-shrink-0 min-w-[160px] sm:min-w-[120px] px-4 py-2 rounded-full font-bold text-base sm:text-sm scroll-snap-align-start ${activeMenu==='laundry' ? 'bg-amber-400 text-pink-900 shadow' : 'bg-transparent text-amber-300'}`}>{t('laundry_service', lang)}</button>
      <button onClick={() => setActiveMenu('homestay')} className={`flex-shrink-0 min-w-[160px] sm:min-w-[120px] px-4 py-2 rounded-full font-bold text-base sm:text-sm scroll-snap-align-start ${activeMenu==='homestay' ? 'bg-amber-400 text-pink-900 shadow' : 'bg-transparent text-amber-300'}`}>{t('homestay_service', lang)}</button>
    </div>
  );
