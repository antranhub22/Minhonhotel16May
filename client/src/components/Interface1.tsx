...
const Interface1: React.FC<Interface1Props> = ({ isActive }) => {
  ...
  const iconDisplayNames: Record<string, string> = {
    // TOURISM & TOURS
    tour_halfday: 'Tour_Nửa_ngày (Half Day)',
    tour_fullday: 'Tour_Một_ngày (Full Day)',
    tour_multiday: 'Tour_Dài_ngày (2 Days & More)',
    special_tour: 'Tour_đặc_biệt (Special Tours)',
    // BUS TICKETS
    bus_hcm: 'bus_hcm (HCM)',
    bus_dl: 'bus_dl (Đà Lạt)',
    bus_nt: 'bus_nt (Nha Trang)',
    bus_dn: 'bus_dn (Đà Nẵng)',
    bus_ct: 'bus_ct (Cần Thơ)',
    bus_mt: 'bus_mt (Mỹ Tho)',
    bus_vt: 'bus_vt (Vũng Tàu)',
    bus_other: 'bus_other (Other Routes)',
    // VEHICLE RENTAL
    motorcycle: 'motorcycle (Thuê xe máy)',
    car_driver: 'car_driver (Thuê ô tô có tài xế)',
    car_self: 'car_self (Thuê ô tô tự lái)',
    // CURRENCY EXCHANGE
    usd: 'usd (US Dollar)',
    eur: 'eur (Euro)',
    krw: 'krw (Korean Won)',
    rub: 'rub (Russian Ruble)',
    currency_other: 'currency_other (Other)',
    // LAUNDRY SERVICE
    laundry_regular: 'laundry_regular (Giặt thường)',
    laundry_special: 'laundry_special (Giặt đặc biệt)',
    laundry_express: 'laundry_express (Giặt nhanh)',
    laundry_additional: 'laundry_additional (Dịch vụ bổ sung)',
    // HOMESTAY SERVICE
    homestay_300k: 'homestay_300k (under 300k)',
    homestay_300_600k: 'homestay_300_600k (300-600k)',
    homestay_600k: 'homestay_600k (over 600k)',
    homestay_longterm: 'homestay_longterm (Long-term)',
    homestay_fullhouse: 'Thuê nhà Nguyên căn (Full House)',
    homestay_additional: 'homestay_additional (Additional Services)',
  };
